...
{isFieldRole&&<label className="device-switch"><span>Aperçu</span><select aria-label="Format d’aperçu" value={devicePreview} onChange={e=>setDevicePreview(e.target.value as 'mobile'|'tablet'|'desktop')}><option value="mobile">Mobile</option><option value="tablet">Tablette</option><option value="desktop">Desktop</option></select></label>}
<span className="live">
