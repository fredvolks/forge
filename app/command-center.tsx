...
export function CommandCenter({role,companyId,initialTab='Commandes',showNav=true}:{role:Role;companyId:string;initialTab?:string;showNav?:boolean}){
